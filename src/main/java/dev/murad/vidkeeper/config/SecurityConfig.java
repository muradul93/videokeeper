...
import dev.murad.vidkeeper.service.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/static/videos/**").permitAll()
                        .requestMatchers("/static/videos/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/activity-log/**").hasAnyRole("USER","ADMIN")
